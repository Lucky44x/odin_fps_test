...
dbg_input_enqueue_func: proc(rl.KeyboardKey)
dbg_input_unload_func: proc()
dbg_input_clear_func: proc()

init :: proc(input_setup: proc() -> (proc(rl.KeyboardKey), proc(), proc())) -> bool {
    dbg_input_enqueue_func, dbg_input_unload_func, dbg_input_clear_func = input_setup()
